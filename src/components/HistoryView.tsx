      ...
      <div className="space-y-3">
        {history.map((item, idx) => (
          <button
            ...
            className="w-full bg-white p-5 rounded-2xl shadow-sm border border-blue-50 flex items-center justify-between hover:border-sky-300 hover:shadow-md transition-all text-left"
          >
            <div>
